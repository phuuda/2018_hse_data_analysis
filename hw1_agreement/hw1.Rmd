...
df <- read.csv("https://raw.githubusercontent.com/phuuda/2018_hse_data_analysis/master/hw1_agreement/hw1_1_zilo_class.csv", header = TRUE, sep=",")
...
### 2.1
```{r}
verbs <- read.csv("https://raw.githubusercontent.com/phuuda/2018_hse_data_analysis/master/hw1_agreement/hw1_2_verbs.csv", header = TRUE, sep=",")
